...
//       <p className='pb-8 text-slate-400 text-center'>We'd love  have you on board. Join over 500+  <br/> customers around the globe nd enhance productivity.</p>
//       </section>
//       <section className='flex flex-col items-center justify-center'>
...
//         <label className='text-start font-bold required-field py-4'>FirstName</label>
//         <input
//             type="string"
//             placeholder="Enter your First Name"
//             className='border h-[50px] border-gray-200 w-full rounded-lg p-2 focus:outline-gray-300'
//             value={firstName}
...
//         </section>
//         <section className='w-full my-2'>
//           <label className='text-start font-bold required-field py-4'>Last Name</label>
//           <input
//             className='border h-[50px] border-gray-200 w-full rounded-lg p-2 focus:outline-gray-300'
//             type="string"
...
//         <section className='w-full my-2'>
//           <label className='text-start font-bold required-field py-4'>Email</label>
//           <input
//             className='border h-[50px] border-gray-200 w-full rounded-lg p-2 focus:outline-gray-300'
//             type="email"
...
//         <section className='w-full my-2'>
//           <label className='text-start font-bold required-field py-4'>Password</label>
//           <input
//             className='border h-[50px] border-gray-200 w-full rounded-lg p-2 focus:outline-gray-300'
//             type="password"
...
//           />
//         </section>
//         <button className='w-full h-[50px] my-8 rounded-2xl bg-black text-slate-200' type="submit">Sign Up</button>
//       </form>
